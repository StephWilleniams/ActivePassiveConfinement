"""Figure 3(a): heatmap of active (swimmer) boundary accumulation E^a over the (k, tau) kick-parameter plane (25 x 25 grid over 4096 Saltelli runs).

Renders a simple version of this panel from figure_3_a.csv alone (no processing).
Run: python3 figure_3_a.py
"""
...
fig.colorbar(im, ax=ax, label=r"$E^{\,a} = \phi^{a}/\phi_{\rm unif}$")
