"""Figure 2(a): scattering time and exit-angle histograms, kick-free baseline (k = 0).

Renders a simple version of this panel from figure_2_a.csv alone (no processing).
Run: python3 figure_2_a.py
"""
