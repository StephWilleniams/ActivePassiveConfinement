"""Figure 2(b): scattering time and exit-angle histograms, LRHS (k = 0.05, tau = 13.5).

Renders a simple version of this panel from figure_2_b.csv alone (no processing).
Run: python3 figure_2_b.py
"""
