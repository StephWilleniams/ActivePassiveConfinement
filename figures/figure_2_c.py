"""Figure 2(c): scattering time and exit-angle histograms, HRLS (k = 45, tau = 0.05).

Renders a simple version of this panel from figure_2_c.csv alone (no processing).
Run: python3 figure_2_c.py
"""
