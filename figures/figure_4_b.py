"""Figure 4(b): local wall-normal drift V_y(y_eff) at the four kick-parameter corners; faint raw per-bin curves under a LOESS trend.

Renders a simple version of this panel from figure_4_b.csv alone (no processing).
Run: python3 figure_4_b.py
"""
...
ax.set_ylabel(r"$\langle V_y(y_{\mathrm{eff}})\rangle$")
