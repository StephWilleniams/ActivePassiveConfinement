"""SM Figure S4, right panel: Fig. 4(e) (HRHS) as a CDF -- cumulative mass from the wall inward.

Renders a simple version of this panel from figure_s4_b.csv alone (no processing).
Run: python3 figure_s4_b.py
"""
...
ax.set_ylabel(r"$F(y_{\mathrm{eff}})$")
ax.set_title("HRHS")
