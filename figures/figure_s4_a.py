"""SM Figure S4, left panel: Fig. 4(d) (LRLS) as a CDF -- cumulative mass from the wall inward.

Renders a simple version of this panel from figure_s4_a.csv alone (no processing).
Run: python3 figure_s4_a.py
"""
