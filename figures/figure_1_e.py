"""Figure 1(e): stationary distributions of both species, strongest kick regime (k = 45 s^-1, tau = 13.5).

Renders a simple version of this panel from figure_1_e.csv alone (no processing).
Run: python3 figure_1_e.py
"""
