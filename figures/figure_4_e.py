"""Figure 4(e): HRHS passive stationary distribution -- measured KDE vs the MTM and jump-KM reconstructions.

Renders a simple version of this panel from figure_4_e.csv alone (no processing).
Run: python3 figure_4_e.py
"""
